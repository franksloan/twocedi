        ...
        <div class="row">
          <div class="col-xs-6 col-md-3">
            <a href='img/tees/16.jpg' class="thumbnail">
              <img src="img/tees/16.jpg" data-src="holder.js/100x180" alt="...">
            </a>
          </div>
          <div class="col-xs-6 col-md-3">
        ...
        <div class="row">
          <div class="col-xs-6 col-md-3">
            <a href='img/tees/13.jpg' class="thumbnail">
              <img src="img/tees/13.jpg" data-src="holder.js/100x180" alt="...">
            </a>
          </div>
          <div class="col-xs-6 col-md-3">
            <a href='img/tees/26jpg' class="thumbnail">
              <img src="img/tees/26.jpg" data-src="holder.js/100x180" alt="...">
            </a>
          </div>
          <div class="col-xs-6 col-md-3">
            <a href='img/tees/25.jpg' class="thumbnail">
              <img src="img/tees/25.jpg" data-src="holder.js/100x180" alt="...">
            </a>
          </div>
          <div class="col-xs-6 col-md-3">
            <a href='img/tees/27.jpg' class="thumbnail">
              <img src="img/tees/27.jpg" data-src="holder.js/100x180" alt="...">
            </a>
          </div>
        </div>
      </div>
